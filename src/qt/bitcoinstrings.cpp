...
"for example: alertnotify=echo %%s | mail -s \"GhostCoin Alert\" admin@foo."
"com\n"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Initialization sanity check failed. GhostCoin is shutting down."),
