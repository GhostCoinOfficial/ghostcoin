...
static const int LAST_POW_BLOCK = 4188;
...
static const uint256 hashGenesisBlock("0x000001f4c2d41698b377220712a6da818c904c534b36af5f9392285d8cf03822");
static const uint256 hashGenesisBlockTestNet("0x00008a10a563084d41e3e894804f6dd62b30d0b11db20720ddb9286d32f4831f");
static const uint256 hashGenesisMerkleRoot("0xb0b8b2857bbeb7b16d5bbf8f49aeee3b5a96966450ebb10ccbc7262cf373752e");
...
public:
    ...
    std::string ToString() const
    {
        return strprintf("CBlockIndex(nprev=%p, pnext=%p, nFile=%u, nBlockPos=%-6d nHeight=%d, nMint=%s, nFlags=(%s)(%d)(%s), nStakeModifier=%016"PRIx64", nStakeModifierChecksum=%08x, hashProof=%s, prevoutStake=(%s), nStakeTime=%d merkle=%s, hashBlock=%s)",
